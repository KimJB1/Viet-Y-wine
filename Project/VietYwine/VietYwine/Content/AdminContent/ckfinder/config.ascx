...
<script runat="server">
    ...
    public override void SetConfig()
    {
        ...
        BaseUrl = "/Content/AdminContent/Upload";

        // The phisical directory in the server where the file will end up. If
        // blank, CKFinder attempts to resolve BaseUrl.
        BaseDir = HttpContext.Current.Server.MapPath("~/Content/AdminContent/Upload");
        ...
        ResourceType type;
        type = ResourceType.Add( "Tệp của " + " " + Session["userName"].ToString() );
        type.Url = BaseUrl + "Files/" + Session["userID"].ToString() +"/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "Files/" + Session["userID"].ToString() + "/";
        type.MaxSize = 0;
        ...
        type = ResourceType.Add("Ảnh của "+" "+Session["userName"].ToString());
        type.Url = BaseUrl + Session["userID"].ToString() +"/";
        type.Dir = BaseDir == "" ? "" : BaseDir + Session["userID"].ToString() + "/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] { "bmp", "gif", "jpeg", "jpg", "png" };
        type.DeniedExtensions = new string[] { };
        
        type = ResourceType.Add("Album");
        type.Url = BaseUrl + "Album/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "Album/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] { "7z", "aiff", "asf", "avi", "bmp", "csv", "doc", "docx", "fla", "flv", "gif", "gz", "gzip", "jpeg", "jpg", "mid", "mov", "mp3", "mp4", "mpc", "mpeg", "mpg", "ods", "odt", "pdf", "png", "ppt", "pptx", "pxd", "qt", "ram", "rar", "rm", "rmi", "rmvb", "rtf", "sdc", "sitd", "swf", "sxc", "sxw", "tar", "tgz", "tif", "tiff", "txt", "vsd", "wav", "wma", "wmv", "xls", "xlsx", "zip" };
        type.DeniedExtensions = new string[] { };
    }
